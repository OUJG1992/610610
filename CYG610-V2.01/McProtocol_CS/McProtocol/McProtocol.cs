...
namespace Nc
{
    namespace Mitsubishi
    {
        ...
        abstract public class McProtocolApp : Plc
        {
            ...
            public string HostName { get; set; }   // 主机名或IP地址
            public int PortNumber { get; set; }    // 端口编号
            // ====================================================================================
            // 构造器
            ...
            private byte[] TryExecution(byte[] iCommand)
            {
                ...
                do
                {
                    ...
                    if (tCount < 0)
                    {
                        throw new Exception("无法从PLC获取正确值.");
                    }
            ...
            class McCommand
            {
                private McFrame FrameType { get; set; }  // 框架类型
                private uint SerialNumber { get; set; }  // 序列号
                private uint NetwrokNumber { get; set; } // 网络编号
                private uint PcNumber { get; set; }      // PC编号
                private uint IoNumber { get; set; }      // 请求单元I/O编号
                private uint ChannelNumber { get; set; } // 请求目标单元站编号
                private uint CpuTimer { get; set; }      // CPU监控计时器
                private int ResultCode { get; set; }     // 结束代码
